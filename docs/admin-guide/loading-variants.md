...
All variants with rank score above `rank_threshold` are loaded. All mitochondrial variants, all variants annotated pathogenic/likely pathogenic or with conflicting interpretations in ClinVar,
and all variants matching the collection of managed variants or marked causative in other cases are also loaded.
