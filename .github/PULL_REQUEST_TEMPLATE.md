...
1. Fist book your testing time using the Pax software available at https://pax.scilifelab.se/. The resource you are going to call dibs on is `scout-stage` and the server is `cg-vm1`.
