...
# Alternative local rank score files
rank_score_path = str(files(BASE_PATH).joinpath("rank_model_-v1.20-.ini"))
sv_rank_score_path = str(files(BASE_PATH).joinpath("svrank_model_-v1.5-.ini"))
...
clinical_fusion_path = str(files(BASE_PATH).joinpath("fusion_data.vcf.gz"))
