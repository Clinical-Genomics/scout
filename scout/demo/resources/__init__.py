...
# Gene paths
reduced_resources_path = importlib_resources.files("scout") / "demo/resources"
hgnc_reduced_path = importlib_resources.files("scout") / "demo/resources/hgnc_reduced_set.txt"
exac_reduced_path = (
...
genes37_reduced_path = (
    importlib_resources.files("scout") / "demo/resources/ensembl_genes_37_reduced.txt"
)
genes38_reduced_path = (
    importlib_resources.files("scout") / "demo/resources/ensembl_genes_38_reduced.txt"
)
exons37_reduced_path = (
    importlib_resources.files("scout") / "demo/resources/ensembl_exons_37_reduced.txt"
)
exons38_reduced_path = (
    importlib_resources.files("scout") / "demo/resources/ensembl_exons_38_reduced.txt"
)

# OMIM paths
mim2gene_reduced_path = importlib_resources.files("scout") / "demo/resources/mim2gene_reduced.txt"
genemap2_reduced_path = importlib_resources.files("scout") / "demo/resources/genemap2_reduced.txt"

# HPO paths
hpoterms_reduced_path = importlib_resources.files("scout") / "demo/resources/reduced.hpo.obo"
...
hpo_terms_def_path = importlib_resources.files("scout") / "demo/resources/hpo_terms.csv"
