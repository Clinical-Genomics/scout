...
class FixtureAdapter(BaseAdapter):
  ...
  def init_app(self, app):
    ...
    cases_path = os.path.join(project_root, 'tests/fixtures/cases.json')
    ...
    with io.open(cases_path, encoding='utf-8') as handle:
      self._cases = json.load(handle)
