...
INHERITANCE_PALETTE = {
    ...
    "DD": {"bgcolor": "bg-secondary", "text_color": "text-white"},
    "DR": {"bgcolor": "bg-secondary", "text_color": "text-white"},
...
UPDATE_GENES_RESOURCES = {
    ...
    "exac_lines": [
        "gnomad.v4.1.1.constraint_metrics.tsv",
        "gnomad.v4.1.1.constraint_metrics_reduced.tsv",
    ],
...
GNOMAD_CONSTRAINT_FILENAME = "gnomad.v4.1.1.constraint_metrics.tsv"
