...
SO_TERMS = {
    ...
    'stop_retained_variant': {'rank':18, 'region':'exonic'},
    'coding_sequence_variant': {'rank':19, 'region':'exonic'},
    'mature_miRNA_variant': {'rank':20, 'region':'ncRNA_exonic'},
    '5_prime_UTR_variant': {'rank':21, 'region':'5UTR'},
    '3_prime_UTR_variant': {'rank':22, 'region':'3UTR'},
    'non_coding_transcript_exon_variant': {'rank':23, 'region':'ncRNA_exonic'},
    'non_coding_exon_variant': {'rank':24, 'region':'ncRNA_exonic'},
    'non_coding_transcript_variant': {'rank':25, 'region':'ncRNA_exonic'},
    'nc_transcript_variant': {'rank':26, 'region':'ncRNA_exonic'},
    'intron_variant': {'rank':27, 'region':'intronic'},
    'NMD_transcript_variant': {'rank':28, 'region':'ncRNA'},
    'upstream_gene_variant': {'rank':29, 'region':'upstream'},
    'downstream_gene_variant': {'rank':30, 'region':'downstream'},
    'TFBS_ablation': {'rank':31, 'region':'TFBS'},
    'TFBS_amplification': {'rank':32, 'region':'TFBS'},
    'TF_binding_site_variant': {'rank':33, 'region':'TFBS'},
    'regulatory_region_ablation': {'rank':34, 'region':'regulatory_region'},
