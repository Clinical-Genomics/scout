...
VERBS_ICONS_MAP = {
    ...
    "unassign": "icon fas fa-times",
    "status": "icon fas fa-star",
    "comment": "icon fas fa-comment",
    "comment_update": "icon fas fa-comment",
    "synopsis": "icon fas fa-folder-open",
    "pin": "icon fas fa-map-pin",
    "unpin": "icon fas fa-map-pin",
    "sanger": "icon fas fa-check",
    "cancel_sanger": "icon fas fa-times",
    "archive": "icon fas fa-archive",
    "open_research": "icon fas fa-search",
    "reset_research": "icon fas fa-search",
    "mark_causative": "icon fas fa-check-double",
    "unmark_causative": "icon fas fa-check-double",
    "mark_partial_causative": "icon fas fa-check-double",
    "unmark_partial_causative": "icon fas fa-check-double",
    "manual_rank": "icon fas fa-check-double",
    "cancer_tier": "icon fas fa-check-double",
    "add_phenotype": "icon fas fa-folder-open",
    "remove_phenotype": "icon fas fa-folder-open",
    "add_case": "icon fas fa-folder-open",
    "update_case": "icon fas fa-folder-open",
    "update_individual": "icon fas fa-folder-open",
    "check_case": "icon fas fa-star",
    "share": "icon fas fa-search",
    "unshare": "icon fas fa-times",
    "rerun": "icon fas fa-gears",
    "rerun_monitor": "icon fas fa-gears",
    "rerun_unmonitor": "icon fas fa-gears",
    "validate": "icon fas fa-check",
    "update_diagnosis": "icon fas fa-folder-open",
    "add_cohort": "icon fas fa-folder-open",
    "remove_cohort": "icon fas fa-folder-open",
    "acmg": "icon fas fa-check-double",
    "dismiss_variant": "icon fas fa-times",
    "reset_dismiss_variant": "icon fas fa-times",
    "reset_dismiss_all_variants": "icon fas fa-times",
    "mosaic_tags": "icon fas fa-check-double",
    "update_default_panels": "icon fas fa-folder-open",
    "update_clinical_filter_hpo": "icon fas fa-folder-open",
    "mme_add": "icon fas fa-share",
    "mme_remove": "icon fas fa-share",
    "filter_stash": "icon fas fa-search",
    "filter_audit": "icon fas fa-search",
    "update_sample": "icon fas fa-folder-open",
    "update_case_group_ids": "icon fas fa-folder-open",
}
