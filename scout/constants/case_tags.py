...
EVENTS_MAP = {
    ...
    "unpin": f"Removed pinned nof event_type variant",
    ...
    "remove_variants": f"Removed nof event_type variants",
    "add_case": f"Added nof case",
    "update_case": f"Updated nof case",
    "update_individual": f"Updated nof individuals",
    "check_case": f"Marked nof event_type case",
    "share": f"Shared case",
    ...
    "dismiss_variant": f"Dismissed nof event_type variant",
    "reset_dismiss_variant": f"Reset nof event_type dismissed variant",
    "reset_dismiss_all_variants": f"Reset all dismissed variants",
    "mosaic_tags": f"Updated mosaic tags",
    "update_default_panels": f"Updated nof event_type default panels",
