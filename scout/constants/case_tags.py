...
EVENTS_MAP = {
    ...
    "status": f"Updated the status on nof event_type",
    ...
    "unpin": f"Removed pinned variant",
    ...
    "unmark_causative": f"Unmarked causative",
    "mark_partial_causative": f"Mark partial causative",
    "unmark_partial_causative": f"Unmarked partial causative",
    "manual_rank": f"Updated manual rank",
    "cancer_tier": f"Updated cancer tier",
    "add_phenotype": f"Added HPO term",
    "remove_phenotype": f"Removed HPO term",
    "remove_variants": f"Removed variants",
    "add_case": f"Added case",
    "update_case": f"Updated case",
    "update_individual": f"Updated individuals",
    "check_case": f"Marked case",
    "share": f"Shared case",
    ...
    "acmg": f"Updated ACMG classification",
    "dismiss_variant": f"Dismissed variant",
    "reset_dismiss_variant": f"Reset dismissed variant",
    "reset_dismiss_all_variants": f"Reset all dismissed variants",
    "mosaic_tags": f"Updated mosaic tags",
    "update_default_panels": f"Updated default panels",
    "update_clinical_filter_hpo": f"Updated clinical filter HPO status",
    "mme_add": f"Exported to Matchmaker",
    "mme_remove": f"Removed from Matchmaker",
