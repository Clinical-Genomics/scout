...
from .gene_tags import (GENE_CUSTOM_INHERITANCE_MODELS,
                        INCOMPLETE_PENETRANCE_MAP, MODELS_MAP,
                        PANEL_GENE_INFO_MODELS, PANEL_GENE_INFO_TRANSCRIPTS,
                        UPDATE_GENES_RESOURCES, VALID_MODELS)
...
from .variant_tags import (CANCER_SPECIFIC_VARIANT_DISMISS_OPTIONS,
                           ...
                           MOSAICISM_OPTIONS, SPIDEX_HUMAN, SPIDEX_LEVELS,
                           SV_TYPES, VARIANT_CALL, VARIANT_FILTERS,
                           VARIANT_REPORT_VARIANT_FEATURES)
from .variants_export import (EXPORT_HEADER, MT_COV_STATS_HEADER,
