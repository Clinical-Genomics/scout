...
from .case_tags import (ANALYSIS_TYPES, CANCER_PHENOTYPE_MAP,
                        ...
                        CASE_STATUSES, CUSTOM_CASE_REPORTS, PHENOTYPE_MAP,
                        REV_PHENOTYPE_MAP, REV_SEX_MAP, SAMPLE_SOURCE, SEX_MAP,
                        VERBS_ICONS_MAP, VERBS_MAP)
from .clinvar import (AFFECTED_STATUS, ALLELE_OF_ORIGIN, ASSERTION_METHOD,
                      ASSERTION_METHOD_CIT, CLINVAR_INHERITANCE_MODELS,
                      CLINVAR_SV_TYPES, CLNSIG_TERMS, COLLECTION_METHOD,
                      PHENO_DBS)
...
from .gene_tags import (GENE_PANELS_INHERITANCE_MODELS,
                        INCOMPLETE_PENETRANCE_MAP, INHERITANCE_PALETTE,
                        MODELS_MAP, PANEL_GENE_INFO_MODELS,
...
from .phenotype import (COHORT_TAGS, HPO_URL, HPOTERMS_URL, PHENOTYPE_GROUPS,
