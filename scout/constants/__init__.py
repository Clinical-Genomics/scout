...
from .variant_tags import (CONSEQUENCE, CONSERVATION, DISMISS_VARIANT_OPTIONS,
                           ...
                           GENETIC_MODELS, VARIANT_CALL, CANCER_TIER_OPTIONS,
                           CANCER_SPECIFIC_VARIANT_DISMISS_OPTIONS, MANUAL_RANK_OPTIONS,
                           MOSAICISM_OPTIONS)
from .case_tags import (ANALYSIS_TYPES, SEX_MAP, REV_SEX_MAP, PHENOTYPE_MAP, CANCER_PHENOTYPE_MAP,
                        REV_PHENOTYPE_MAP, CASE_STATUSES, VERBS_MAP, VERBS, SAMPLE_SOURCE)
