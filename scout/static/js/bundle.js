...
var ToggleClassButton = React.createClass({displayName: 'ToggleClassButton',
	query: '',
	toggleClass: '',
	...
	render: function() {
		return React.createElement("div", {onClick: this.handleClick, className: "button-menu"})
	}
});

// Render HelloMessage component at #name.
React.render(
  React.createElement(ToggleClassButton, {icon: "menu", query: ".drawer-panel-aside", toggleClass: "is-showing"}),
