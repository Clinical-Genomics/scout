...
def build_case(case_data):
    ...
    case_obj.rank_score_treshols = case_data.get('rank_score_treshold')
    ...
    # Gene panels
    case_obj.default_panels = case_data['default_panels']
    case_obj.gene_panels = case_data['gene_panels']
