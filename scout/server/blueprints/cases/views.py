...
def causatives(institute_id):
    ...
    variants = store.check_causatives(institute_obj=institute_obj,limit_genes=hgnc_id).sort("hgnc_symbol", pymongo.ASCENDING).sort("genes.hgnc_symbol", pymongo.ASCENDING)
    all_variants = {}
    all_cases = {}
