...
def coverage_report_contents(store, institute_obj, case_obj, base_url):
    ...
    resp = requests.request('GET', url_for(base_url+'report.report', sample_id=post_request_data['sample_id'], level=post_request_data['level'], panel_name=post_request_data['panel_name']))
