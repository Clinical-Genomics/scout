...
from scout.constants import (CANCER_PHENOTYPE_MAP, CASE_REPORT_VARIANT_TYPES,
                             CASE_TAGS, CUSTOM_CASE_REPORTS,
                             DATE_DAY_FORMATTER, MITODEL_HEADER,
                             MT_COV_STATS_HEADER, MT_EXPORT_HEADER,
                             PHENOTYPE_GROUPS, PHENOTYPE_MAP, SAMPLE_SOURCE,
                             SEX_MAP, VERBS_MAP)
...
from scout.server.utils import (case_has_alignments, case_has_chanjo2_coverage,
