...
<b>OBS</b>: in order to convert HTML reports into PDF reports, we are currently switching to the [python-pdfkit](https://github.com/JazzCore/python-pdfkit) library. For this reason, when upgrading to a Scout version >4.47, you'll need to install an additional [wkhtmltopdf system library](https://wkhtmltopdf.org/).
