...
- Tests involving the variants controllers, which failed when not runned in a specific order (#5391)
- Option to return to previous step in one of the steps of the ClinVar submission form (#5393)
