...
- Improved visibility of links when in dark mode (#6564 and #6576)
...
- Automatically use genome build 38 for MT/M variants when determining the variant locus ()
...
- Panel maintainer badge not shown to users logged in via LDAP (#6444)
