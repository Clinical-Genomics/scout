from scout.server.blueprints.variants.controllers import sanger, cancel_sanger, variants_export_header, variant_export_lines
...
def test_variant_csv_export(real_variant_database, case_obj):
    ...
    # Assert that exported document has 8 fields:
    # n = (EXPORT_HEADER in variants_export.py) + (3 * number of individuals analysed for the case)
