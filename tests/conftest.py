...
from scout.demo import (cancer_load_path, cancer_snv_path, cancer_sv_path, clinical_snv_path,
                        clinical_str_path, clinical_sv_path, customannotation_snv_path,
                        empty_sv_clinical_path, load_path, panel_path, ped_path, research_snv_path,
                        research_sv_path, vep_97_annotated_path)
# These are the reduced data files
from scout.demo.resources import (exac_reduced_path, exons37_reduced_path, exons38_reduced_path,
                                  genemap2_reduced_path, genes37_reduced_path, genes38_reduced_path,
                                  genes_to_phenotype_reduced_path, hgnc_reduced_path,
                                  hpoterms_reduced_path, mim2gene_reduced_path,
                                  phenotype_to_genes_reduced_path, transcripts37_reduced_path,
