...
def cli(ctx, gene_list, panel_name):
    ...
    click.echo("##institute={}".format(
        panel_metadata[panel_name]['institute']
    ))
    click.echo("##version={}".format(
        panel_metadata[panel_name]['version']
    ))
    click.echo("##date={}".format(
        panel_metadata[panel_name]['date']
    ))
    click.echo("##institute={}".format(
        panel_metadata[panel_name]['institute']
    ))
